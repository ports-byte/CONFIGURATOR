 ...
 * is closed.
 *
 * @see net.Network#Network(int, net.Network_iface, int)
 *
...
public interface Network_iface {
     ...
     *            {@link net.Network#Network(int, net.Network_iface, int)} in the
     ...
     * {@link net.Network} (
     * {@link net.Network#Network(int, net.Network_iface, int)}), without the
